...
- [x] 2. `GravatarStyles.All` in `Tharga.Team`, with the styles and their display names. Point
...
- [x] 3. `IIconSettingsStore` in `Tharga.Team` + `MongoIconSettingsStore` in `Tharga.Team.MongoDB`, mirroring
...
- [x] 3b. The cache in front of the store: cleared outright on save, and otherwise expiring after
